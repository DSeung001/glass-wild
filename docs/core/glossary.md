...
- D-001·D-006의 **배경화면** (데스크톱 관찰 모드 — 의도된 제품)
...
| 편집 화면 | edit view | 격자 표시, 블록형 배치 (D-003) | |
...
| 활동 구역 | activity zone | 바닥·식물·벽면·수중 등 | |
| 안정 / 주의 / 위험 / 긴급 | status bands | 문서 공통 상태 용어 | 임의 동의어 혼용 |
...
| 한국어 | ID / 영문 | 정의 | 쓰지 말 것 |
|---|---|---|---|
| 논리 격자 | logic grid | 판정·길찾기·저장 셀 (D-003) | |
| 스프라이트 셀 | sprite cell | 이미지 캔버스 32/48/64 (D-002) | 논리 셀 px와 동일시 |
