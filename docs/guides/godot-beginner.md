...
5. **동물**: 클릭. [D-007](../decisions/D-007-mvp-content-count.md) 팔루다리움 예시(+파이어밸리 뉴트). **locomotion**에 맞는 셀만 배치·배회 ([`../entities/animals.md`](../entities/animals.md)). 라벨은 표시 이름, 도형은 색 사각형 더미
